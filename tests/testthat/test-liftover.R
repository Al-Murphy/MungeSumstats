test_that("liftover", {
    ...
    if (!is_32bit_windows) {
        ...
        reformatted2 <- MungeSumstats::format_sumstats(reformatted$sumstats,
                                                      ref_genome = "GRCh38",
                                                      on_ref_genome = TRUE,
        ...
        ref_37_org <- data.table::fread(reformatted3$sumstats)
        ref_37 <- data.table::fread(reformatted2$sumstats)
