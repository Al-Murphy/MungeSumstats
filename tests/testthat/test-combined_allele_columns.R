test_that("Can correctly separate two A1/A2 columns", {
    ...
    if (!is_32bit_windows) {
        ...
        sumstats_dt_missing[, alleles := paste0(A1, " / ", A2)] # and add whitespace
        sumstats_dt_missing[, allele := paste0(A1, ">", A2)]
        ...
        # ignore column order
        expect_equal(all.equal(org_dt, res_dt,
