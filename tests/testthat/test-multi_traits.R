test_that("Multi-trait GWAS handled correctly", {
  ...
  multi_trait_res_smk <- c(
    ...
    "rs1000075\tchr1\t94939420\t94939420\tT\tC\t0.3583\t38959\t-0.0013\t0.0082\t0.8687\t147567\t-0.0043\t0.0044\t0.3259",
    "rs1000085\tchr1\t66630503\t66630503\tC\tG\t0.1667\t38761\t0.0053\t0.0095\t0.5746\t147259\t-0.0034\t0.0052\t0.5157"
  )
